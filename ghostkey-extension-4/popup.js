...
function startReRegister() {
  /* clear profile so setup shows on next open; reset form */
...
function renderEvent(ev) {
  ...
  const circ        = 2 * Math.PI * 15;           /* r=15 → circumference ≈ 94.2 */
...
/* refresh the event list whenever the window regains focus
   (background may have added a new sign-in while popup was open) */
